...
o comando:
\begin{tabbing}\ttfamily
~~~~~\char62{}~quickCheckWith~stdArgs~\char123{}~maxSuccess~\char61{}~200\char44{}~maxSize~\char61{}~10~\char125{}~prop\char13{}\\
\ttfamily ~~~~~\char43{}\char43{}\char43{}~OK\char44{}~passed~200~tests\char46{}\char13{}
\end{tabbing}
...
\ensuremath{(\Varid{extLTree}\;\Varid{bdtGC})}, em que \ensuremath{\Varid{bdtGC}} é a  árvore de decisão binária acima descrita,
e a uma
...
\\
\>[B]{}\Varid{discollect}\;(\Varid{h}\mathbin{:}\Varid{t})\mathrel{=}(\Varid{lstr}\;\Varid{h})\plus \Varid{discollect}\;\Varid{t}{}\<[E]%
\\[\blanklineskip]%
...
\begin{eqnarray*}
\xymatrix@C=2cm{
    \ensuremath{\Conid{Exp}\;\Conid{V}\;\Conid{O}\mathbin{*}}
           \ar[d]_-{\ensuremath{\Varid{cataExp}\;\Varid{g}}}
&
    \ensuremath{\Conid{V}\mathbin{+}\Conid{O}\mathbin{*}\times(\Conid{Exp}\;\Conid{V}\;\Conid{O}\mathbin{*})\mathbin{*}}
           \ar[d]^{\ensuremath{\Varid{recExp}\;(\Varid{cataExp}\;\Varid{g})}}
           \ar[l]_-{\ensuremath{\Varid{inExp}}}
\\
     \ensuremath{((\Conid{O}\mathbin{*},\Conid{V}))\mathbin{*}}
&
     \ensuremath{\Conid{V}\mathbin{+}\Conid{O}\mathbin{*}\times((\Conid{O}\mathbin{*},\Conid{V}))\mathbin{*}}
           \ar[l]^-{\ensuremath{\Varid{g}}}
}
\end{eqnarray*}
%--------------------------------------
...
\column{7}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{tar}\mathbin{::}(\Conid{Ord}\;\Varid{v},\Conid{Ord}\;\Varid{o})\Rightarrow \Conid{Exp}\;\Varid{v}\;[\mskip1.5mu \Varid{o}\mskip1.5mu]\to [\mskip1.5mu ([\mskip1.5mu \Varid{o}\mskip1.5mu],\Varid{v})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{tar}\mathrel{=}\Varid{cataExp}\;\Varid{g}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\Varid{g}\mathrel{=}\alt{\Varid{singl}\comp \conj{\Varid{nil}}{\Varid{id}}}{\uncurry{(\map )}\comp (\Varid{t}\times\Varid{concat})}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{t}\;\Varid{a}\mathrel{=}(\Varid{ccat}\;\Varid{a})\times\Varid{id}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks

A função \ensuremath{\Varid{dic\char95 rd}} tem como objetivo procurar traduções para uma determinada palavra.
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{6}{@{}>{\hspre}l<{\hspost}@{}}%
...
\\
\>[B]{}\Varid{dic\char95 rd}\;\Varid{p}\;\Varid{b}\mathrel{=}\mathbf{if}\;\Varid{dic\char95 exp}\;(\Varid{b})\equiv [\mskip1.5mu \mskip1.5mu]\;\mathbf{then}\;\Conid{Nothing}{}\<[E]%
\\
\>[B]{}\hsindent{14}{}\<[14]%
\>[14]{}\mathbf{else}\;\Varid{cmp}\;{}\<[24]%
\>[24]{}\Varid{p}\;(\Varid{dic\char95 exp}\;\Varid{b}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{cmp}{}\<[6]%
\>[6]{}\mathbin{::}\Conid{String}\to [\mskip1.5mu (\Conid{String},[\mskip1.5mu \Conid{String}\mskip1.5mu])\mskip1.5mu]\to \Conid{Maybe}\;[\mskip1.5mu \Conid{String}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{cmp}\;{}\<[6]%
\>[6]{}\Varid{p}\;(\Varid{s1}\mathbin{:}\Varid{s2})\mathrel{=}\mathbf{if}\;\p1\;\Varid{s1}\equiv \Varid{p}\;\mathbf{then}\;\Conid{Just}\;(\p2\;\Varid{s1}){}\<[E]%
\\
\>[6]{}\hsindent{17}{}\<[23]%
\>[23]{}\mathbf{else}\;\mathbf{if}\;\Varid{s2}\equiv [\mskip1.5mu \mskip1.5mu]\;\mathbf{then}\;\Conid{Nothing}{}\<[E]%
\\
\>[23]{}\hsindent{5}{}\<[28]%
\>[28]{}\mathbf{else}\;\Varid{cmp}\;\Varid{p}\;\Varid{s2}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
    \ensuremath{\mathrm{1}\mathbin{+}\Conid{A}\times\Conid{String}}
           \ar[d]^{\ensuremath{\Varid{recList}\;(\Varid{anaList}\;\Varid{h})}}
\\
     \ensuremath{\Conid{String}\mathbin{*}}
        \ar[d]_-{\ensuremath{\Varid{cataList}\;\Varid{g}}}
        \ar[r]^-{\ensuremath{\Varid{out}}}
&
     \ensuremath{\mathrm{1}\mathbin{+}\Conid{A}\times\Conid{String}\mathbin{*}}
           \ar[l]^-{\ensuremath{\mathbf{in}}}
            \ar[d]^{\ensuremath{\Varid{recList}\;(\Varid{cataList}\;\Varid{g})}}
\\
    \ensuremath{(\Conid{String},\Conid{String}\mathbin{*})\mathbin{*}}
&
    \ensuremath{\mathrm{1}\mathbin{+}\Conid{A}\mathbin{+}(\Conid{String},\Conid{String}\mathbin{*})\mathbin{*}}
        \ar[l]^-{\ensuremath{\Varid{g}}}
}
%--------------------------------------
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\underline{\Conid{Nothing}}}{\Varid{dirAux}}\;\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{10}{}\<[13]%
\>[13]{}\Varid{dirAux}\;(\Varid{a},(\Conid{Nothing},\Conid{Nothing}))\mathrel{=}\Conid{Just}\;\Varid{a}{}\<[E]%
\\
\>[3]{}\hsindent{10}{}\<[13]%
\>[13]{}\Varid{dirAux}\;(\Varid{a},(\Conid{Nothing},\Conid{Just}\;\Varid{t2}))\mathrel{=}\Conid{Just}\;\Varid{t2}{}\<[E]%
\\
\>[3]{}\hsindent{10}{}\<[13]%
\>[13]{}\Varid{dirAux}\;(\Varid{a},(\Conid{Just}\;\Varid{t1},\Conid{Nothing}))\mathrel{=}\Conid{Just}\;\Varid{a}{}\<[E]%
\\
\>[3]{}\hsindent{10}{}\<[13]%
\>[13]{}\Varid{dirAux}\;(\Varid{a},(\Conid{Just}\;\Varid{t1},\Conid{Just}\;\Varid{t2}))\mathrel{=}\Conid{Just}\;\Varid{t2}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{maisEsq}\mathrel{=}\Varid{cataBTree}\;\Varid{g}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}{}\<[14]%
\>[14]{}\alt{\underline{\Conid{Nothing}}}{\Varid{esqAux}}\;\mathbf{where}{}\<[E]%
\\
\>[14]{}\Varid{esqAux}\;(\Varid{a},(\Conid{Nothing},\Conid{Nothing}))\mathrel{=}\Conid{Just}\;\Varid{a}{}\<[E]%
\\
\>[14]{}\Varid{esqAux}\;(\Varid{a},(\Conid{Nothing},\Conid{Just}\;\Varid{t2}))\mathrel{=}\Conid{Just}\;\Varid{a}{}\<[E]%
\\
\>[14]{}\Varid{esqAux}\;(\Varid{a},(\Conid{Just}\;\Varid{t1},\Conid{Nothing}))\mathrel{=}\Conid{Just}\;\Varid{t1}{}\<[E]%
\\
\>[14]{}\Varid{esqAux}\;(\Varid{a},(\Conid{Just}\;\Varid{t1},\Conid{Just}\;\Varid{t2}))\mathrel{=}\Conid{Just}\;\Varid{t1}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=2cm{
    \ensuremath{\fun{BTree} \;\Conid{A}}
           \ar[d]_-{\ensuremath{\Varid{cataBdt}\;\Varid{g}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}\Conid{A}\times(\fun{BTree} \;\Conid{A}\times\fun{BTree} \;\Conid{A})}
           \ar[d]^{\ensuremath{\Varid{recBdt}\;(\Varid{cataBdt}\;\Varid{g})}}
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\conj{\alt{\Varid{true}}{\Varid{false}}}{\Varid{isOrd''}}\;\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{10}{}\<[13]%
\>[13]{}\mbox{\onelinecomment isOrd''= undefined}{}\<[E]%
\\
\>[3]{}\hsindent{10}{}\<[13]%
\>[13]{}\Varid{isOrd''}\;((\Varid{a},(\Conid{Empty},\Conid{Empty})))\mathrel{=}\Varid{true}{}\<[E]%
\\[\blanklineskip]%
\>[3]{}\hsindent{10}{}\<[13]%
\>[13]{}\mbox{\onelinecomment isOrd'' (a,(b,(_,_)))),_)) = if a > b then true else false}{}\<[E]%
\\
\>[3]{}\hsindent{10}{}\<[13]%
\>[13]{}\mbox{\onelinecomment isOrd'' (a,(Empty,(Node(b,(_,_)))),_) = if a < b then true else false}{}\<[E]%
\\
\>[3]{}\hsindent{10}{}\<[13]%
\>[13]{}\mbox{\onelinecomment isOrd'' (a,((Node(b,(_,_))),(Node(c,(_,_)))),_) = if a > b && a < c then true else false}{}\<[E]%
\\[\blanklineskip]%
...
splay l t =  flip (cataBTree (either g1 g2)) where
             ...
             g2 (a,(left,right)) (h:t) \ensuremath{\Varid{h}\equiv \Varid{true}\mathrel{=}\Varid{l}\;\Varid{t}} otherwise = r t
...
%----------------- Problema 3 ------------------------%
\subsection*{Problema 3}
O objetivo da função \ensuremath{\Varid{extLTree}} é transformar uma \ensuremath{\Conid{Bdtree}} numa \ensuremath{\Conid{Ltree}} utilizando um catamorfismo, de tal modo que \ensuremath{\Varid{extLTree}} = \ensuremath{\Varid{cataBdt}\;\Varid{g}}. 
...
%--------------------------------------
Diagrama da função \ensuremath{\Varid{extLTree}}:
\begin{eqnarray*}
\xymatrix@C=2cm{
    \ensuremath{\Conid{Bdt}\;\Conid{A}}
           \ar[d]_-{\ensuremath{\Varid{cataBdt}\;\Varid{g}}}
&
    \ensuremath{\Conid{A}\mathbin{+}(\mathit B\times\Conid{Bdt}\times\Conid{Bdt})}
           \ar[d]^{\ensuremath{\Varid{recBdt}\;(\Varid{cataBdt}\;\Varid{g})}}
           \ar[l]_-{\ensuremath{\Varid{inBdt}}}
\\
     \ensuremath{\mathsf{LTree}\;\Conid{A}}
&
     \ensuremath{\Conid{Bdt3}}
           \ar[l]^-{\ensuremath{\Varid{g}}}
}
\end{eqnarray*}
%--------------------------------------
...
\\
\>[B]{}\Varid{outBdt}\;(\Conid{Query}\;(\Varid{a},(\Varid{t1},\Varid{t2})))\mathrel{=}i_2\;(\Varid{a},(\Varid{t1},\Varid{t2})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{baseBdt}\;\Varid{e}\;\Varid{f}\;\Varid{g}\mathrel{=}\Varid{e}+(\Varid{f}\times(\Varid{g}\times\Varid{g})){}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\Varid{anaBdt}\;\Varid{f}\mathrel{=}\Varid{inBdt}\comp (\Varid{recBdt}\;(\Varid{anaBdt}\;\Varid{f}))\comp \Varid{f}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
%--------------------------------------

Diagrama de \ensuremath{\Varid{anaBdt}}:

\xymatrix@C=3cm{
    \ensuremath{\Conid{Bdt}\;\Conid{A}}
             \ar[r]^-{\ensuremath{\Varid{outBdt}}}
&
    \ensuremath{\Conid{A}\mathbin{+}(\mathit B\times(\Conid{Bdt}\times\Conid{Bdt}))}
\\
     \ensuremath{\Conid{LTreeA}}
            \ar[u]^-{\ensuremath{\Varid{anaBdt}\;\Varid{f}}}
            \ar[r]_-{\ensuremath{\Varid{f}}}
&
     \ensuremath{\Conid{A}\mathbin{+}(\mathit B\times(\mathsf{LTree}\;\Conid{A}\times\mathsf{LTree}\;\Conid{A}))}
            \ar[u]_{\ensuremath{\Varid{recBdt}\;(\Varid{anaBdt}\;\Varid{f})}}
}
%--------------------------------------
...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\lambda \Varid{a}\;\anonymous \to \Conid{Leaf}\;\Varid{a}}{\Varid{navAux}}\;\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{10}{}\<[15]%
\>[15]{}\Varid{navAux}\;(\Varid{lt1},\Varid{lt2})\;[\mskip1.5mu \mskip1.5mu]{}\<[37]%
\>[37]{}\mathrel{=}\Conid{Fork}\;(\Varid{lt1}\;[\mskip1.5mu \mskip1.5mu],\Varid{lt2}\;[\mskip1.5mu \mskip1.5mu]){}\<[E]%
\\
\>[5]{}\hsindent{10}{}\<[15]%
\>[15]{}\Varid{navAux}\;(\Varid{lt1},\Varid{lt2})\;(\Conid{True}\mathbin{:}\Varid{t}){}\<[43]%
\>[43]{}\mathrel{=}\Varid{lt1}\;\Varid{t}{}\<[E]%
\\
\>[5]{}\hsindent{10}{}\<[15]%
\>[15]{}\Varid{navAux}\;(\Varid{lt1},\Varid{lt2})\;(\Conid{False}\mathbin{:}\Varid{t})\mathrel{=}\Varid{lt2}\;\Varid{t}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks


%--------------------------------------
Apresenta-se de seguida o diagrama da função \ensuremath{\Varid{navLTree}}, esta é um catamorfimo cujo gene é \ensuremath{[\mskip1.5mu \underline{\Conid{Leaf}},\Varid{navAux}\mskip1.5mu]}:
...
&
    \ensuremath{\Conid{A}\mathbin{+}(\Conid{A}\times\mathsf{LTree}\;\Conid{A}\times\mathsf{LTree}\;\Conid{A})}
           \ar[d]^{\ensuremath{\Varid{recLtree}\;(\Varid{cataLTree}\;\Varid{g})}}
           \ar[l]_-{\ensuremath{\Varid{inLTree}}}
\\
     \ensuremath{\Conid{Bool}\mathbin{*}\times\mathsf{LTree}\;\Conid{A}}
&
     \ensuremath{\Conid{A}\mathbin{+}((\Conid{Bool}\mathbin{*}\times\Conid{LTreeA})\times(\Conid{Bool}\mathbin{*}\times\Conid{TreeA}))}
           \ar[l]^-{\ensuremath{\Varid{g}}}
}
\end{eqnarray*}
%--------------------------------------
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\lambda \Varid{a}\;\anonymous \to \Conid{Leaf}\;\Varid{a}}{\Varid{bnavAux}}\;\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{12}{}\<[15]%
\>[15]{}\Varid{bnavAux}\;(\Varid{lt1},\Varid{lt2})\;\Conid{Empty}\mathrel{=}\Conid{Fork}\;(\Varid{lt1}\;\Conid{Empty},\Varid{lt2}\;\Conid{Empty}){}\<[E]%
\\
\>[3]{}\hsindent{12}{}\<[15]%
\>[15]{}\Varid{bnavAux}\;(\Varid{lt1},\Varid{lt2})\;(\Conid{Node}\;(\Conid{True},(\Varid{bt1},\Varid{bt2}))){}\<[58]%
\>[58]{}\mathrel{=}\Varid{lt1}\;\Varid{bt1}{}\<[E]%
\\
\>[3]{}\hsindent{12}{}\<[15]%
\>[15]{}\Varid{bnavAux}\;(\Varid{lt1},\Varid{lt2})\;(\Conid{Node}\;(\Conid{False},(\Varid{bt1},\Varid{bt2})))\mathrel{=}\Varid{lt2}\;\Varid{bt2}{}\<[E]%
\\
\>[3]{}\hsindent{12}{}\<[15]%
\>[15]{}\mbox{\onelinecomment       LTree       BTree(Bool)}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks

%--------------------------------------
Diagrama da função \ensuremath{\Varid{bnavLTree}}:
...
&
    \ensuremath{\Conid{A}\mathbin{+}\mathsf{LTree}\;\Conid{A}\times\mathsf{LTree}\;\Conid{A}}
           ...
           \ar[l]_-{\ensuremath{\Varid{inLtree}}}
\\
     \ensuremath{(\fun{BTree} \;\Conid{Bool})\times\mathsf{LTree}\;\Conid{A}}
&
     \ensuremath{\Conid{A}\mathbin{+}((\fun{BTree} \;\Conid{Bool})\times\mathsf{LTree})\times((\fun{BTree} \;\Conid{Bool})\times\mathsf{LTree})}
           \ar[l]^-{\ensuremath{\Varid{g}}}
}
\end{eqnarray*}
%--------------------------------------
...
%--------------------------------------
Diagrama da função \ensuremath{\Varid{pbnavLTree}}:
...
&
    \ensuremath{\Conid{A}\mathbin{+}\mathsf{LTree}\;\Conid{A}\times\mathsf{LTree}\;\Conid{A}}
           ...
           \ar[l]_-{\ensuremath{\Varid{inLtree}}}
\\
     \ensuremath{(\fun{BTree} \;(\fun{Dist}\;\Conid{Bool}))\times\fun{Dist}\;(\mathsf{LTree}\;\Conid{A})}
&
     \ensuremath{\Conid{A}\mathbin{+}((\fun{BTree} \;(\fun{Dist}\;\Conid{Bool}))\times\fun{Dist}\;(\mathsf{LTree}\;\Conid{A}))\times((\fun{BTree} \;(\fun{Dist}\;\Conid{Bool}))\times\fun{Dist}\;(\mathsf{LTree}\;\Conid{A}))}
           \ar[l]^-{\ensuremath{\Varid{g}}}
}
\end{eqnarray*}
%--------------------------------------
...
\>[31]{}\mbox{\onelinecomment  window title}{}\<[E]%
\\
\>[B]{}\hsindent{14}{}\<[14]%
\>[14]{}(\mathrm{800},\mathrm{800})\;{}\<[31]%
\>[31]{}\mbox{\onelinecomment  window size}{}\<[E]%
\\
\>[B]{}\hsindent{14}{}\<[14]%
\>[14]{}(\mathrm{100},\mathrm{100}){}\<[31]%
\>[31]{}\mbox{\onelinecomment  window position}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{main}\mathrel{=}\mathbf{do}{}\<[E]%
\\
\>[B]{}\hsindent{8}{}\<[8]%
\>[8]{}\Varid{putStrLn}\;\text{\ttfamily \char34 Colunas:~\char34}{}\<[E]%
\\
\>[B]{}\hsindent{8}{}\<[8]%
\>[8]{}\Varid{inputX}\leftarrow \Varid{getLine}{}\<[E]%
\\
\>[B]{}\hsindent{8}{}\<[8]%
\>[8]{}\mathbf{let}\;\Varid{x}\mathrel{=}(\Varid{read}\;\Varid{inputX}\mathbin{::}\Conid{Float}){}\<[E]%
\\
\>[B]{}\hsindent{8}{}\<[8]%
\>[8]{}\Varid{putStrLn}\;\text{\ttfamily \char34 Linhas:~\char34}{}\<[E]%
\\
\>[B]{}\hsindent{8}{}\<[8]%
\>[8]{}\Varid{inputY}\leftarrow \Varid{getLine}{}\<[E]%
\\
\>[B]{}\hsindent{8}{}\<[8]%
\>[8]{}\mathbf{let}\;\Varid{y}\mathrel{=}(\Varid{read}\;\Varid{inputY}\mathbin{::}\Conid{Float}){}\<[E]%
\\
\>[B]{}\hsindent{8}{}\<[8]%
\>[8]{}\mathbf{if}\;(\Varid{x}\mathbin{>}\mathrm{0}\mathrel{\wedge}\Varid{y}\mathbin{>}\mathrm{0}){}\<[E]%
\\
\>[8]{}\hsindent{1}{}\<[9]%
\>[9]{}\mathbf{then}\;(\Varid{\Conid{Control}.\Conid{Monad}.join}\;(\mathsf{fmap}\;\Varid{id}\;((\mathsf{fmap}\;(\Varid{display}\;\Varid{janela}\;\Varid{white})\;(\Varid{pic}\;\Varid{x}\;\Varid{y}))))){}\<[E]%
\\
\>[8]{}\hsindent{1}{}\<[9]%
\>[9]{}\mathbf{else}\;(\Varid{\Conid{Control}.\Conid{Monad}.join}\;(\mathsf{fmap}\;\Varid{id}\;(\mathsf{fmap}\;(\Varid{display}\;\Varid{janela}\;\Varid{white})\;(\Varid{pic}\;\mathrm{10}\;\mathrm{10})))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{pic}\mathbin{::}\Conid{Float}\to \Conid{Float}\to \fun{IO}\;\Conid{Picture}{}\<[E]%
\\
\>[B]{}\Varid{pic}\;\Varid{x}\;\Varid{y}\mathrel{=}\mathsf{fmap}\;\Varid{pictures}\;(\Varid{mapM}\;(\mathsf{fmap}\;\Varid{id})\;(\Varid{coluna}\;(\mathbin{-}\mathrm{40}\mathbin{*}\Varid{x})\;\Varid{y}\;(\mathrm{40}\mathbin{*}\Varid{x})\;[\mskip1.5mu \mskip1.5mu])){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{coluna}\mathbin{::}\Conid{Float}\to \Conid{Float}\to \Conid{Float}\to [\mskip1.5mu \fun{IO}\;\Conid{Picture}\mskip1.5mu]\to [\mskip1.5mu \fun{IO}\;\Conid{Picture}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{coluna}\;\Varid{x}\;\Varid{y}\;\Varid{a}\;\Varid{l}{}\<[E]%
\\
\>[B]{}\hsindent{13}{}\<[13]%
\>[13]{}\mid \Varid{x}\geq \Varid{a}\mathrel{=}\Varid{l}{}\<[E]%
\\
\>[B]{}\hsindent{13}{}\<[13]%
\>[13]{}\mid \Varid{otherwise}\mathrel{=}\Varid{coluna}\;(\Varid{x}\mathbin{+}\mathrm{80})\;\Varid{y}\;\Varid{a}\;(\Varid{l}\plus (\Varid{linha}\;\Varid{x}\;(\mathbin{-}\mathrm{40}\mathbin{*}\Varid{y})\;(\mathrm{40}\mathbin{*}\Varid{y})\;[\mskip1.5mu \mskip1.5mu])){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{linha}\mathbin{::}\Conid{Float}\to \Conid{Float}\to \Conid{Float}\to [\mskip1.5mu \fun{IO}\;\Conid{Picture}\mskip1.5mu]\to [\mskip1.5mu \fun{IO}\;\Conid{Picture}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{linha}\;\Varid{x}\;\Varid{y}\;\Varid{a}\;\Varid{l}{}\<[E]%
\\
\>[B]{}\hsindent{15}{}\<[15]%
\>[15]{}\mid \Varid{y}\geq \Varid{a}\mathrel{=}\Varid{l}{}\<[E]%
\\
\>[B]{}\hsindent{15}{}\<[15]%
\>[15]{}\mid \Varid{otherwise}\mathrel{=}\Varid{linha}\;\Varid{x}\;(\Varid{y}\mathbin{+}\mathrm{80})\;\Varid{a}\;(\Varid{l}\plus [\mskip1.5mu \mathsf{fmap}\;(\Varid{put}\;(\Varid{x},\Varid{y}))\;(\mathsf{fmap}\;\Varid{head}\;(\Varid{permuta}\;[\mskip1.5mu \Varid{truchet1},\Varid{truchet2}\mskip1.5mu]))\mskip1.5mu]){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{6}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment  defs auxiliares -------------}{}\<[E]%
\\
\>[B]{}\Varid{put}{}\<[6]%
