...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mbox{\onelinecomment g = either (id >< i1) (id >< i2)}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mbox{\onelinecomment g = either b1 (b,[b2])}{}\<[E]%
\\[\blanklineskip]%
...
%----------------- Problema 3 ------------------------%
\subsection*{Problema 3}
O objetivo da função \ensuremath{\Varid{extLTree}} é ?? utilizando um catamorfismo, de tal modo que \ensuremath{\Varid{extLTree}} = \ensuremath{\Varid{cataBdt}\;\Varid{g}}. 
...
\begin{eqnarray}
\xymatrix@C=2cm{
    \ensuremath{\Conid{Bdt1}}
        \ar[d]_-{\ensuremath{\Conid{Bdt2}}}
        \ar[r]^-{\ensuremath{\Varid{g}}}
&
    \ensuremath{\Conid{Bdt2}}
           \ar[d]^{\ensuremath{\Varid{recBdt}\;(\Varid{anaBdt}\;\Varid{g})}}
\\
     \ensuremath{\Varid{bdt4}}
&
     \ensuremath{\Conid{Bdt3}}
           \ar[l]^-{\ensuremath{\Varid{inBdt}}}
}
