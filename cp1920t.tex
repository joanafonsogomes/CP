...
\begin{eqnarray*}
\xymatrix@C=2cm{
    \ensuremath{\mathbin{?}\mathrm{1}}
           \ar[d]_-{\ensuremath{\Varid{cataExp}\;\Varid{g}}}
&
    \ensuremath{\mathbin{?}\mathrm{2}}
           \ar[d]^{\ensuremath{\Varid{recExp}\;(\Varid{cataExp}\;\Varid{g})}}
           \ar[l]_-{\ensuremath{\Varid{inExp}}}
\\
     \ensuremath{[\mskip1.5mu (\Varid{a},\Varid{b})\mskip1.5mu]}
&
     \ensuremath{\mathbin{?}\mathrm{3}}
           \ar[l]^-{\ensuremath{\Varid{g}}}
}
\end{eqnarray*}
%--------------------------------------
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathrel{=}\Varid{concat}\comp (\map \;\Varid{auxTar}){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{auxTar}\mathbin{::}(\Conid{String})\to [\mskip1.5mu (\Conid{String}\;\Varid{b},\Conid{String}\;\Varid{b})\mskip1.5mu]{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{auxTar}\;()\mathrel{=}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{auxTar}\;()\mathrel{=}{}\<[E]%
\\
...
\xymatrix@C=3cm{
    \ensuremath{\mathbin{?}\mathrm{1}}
           \ar[d]_-{\ensuremath{\Varid{ana}}}
            \ar[r]^-{\ensuremath{\mathbin{??}\mathrm{1}}}
&
    \ensuremath{\mathbin{?}\mathrm{2}}
           \ar[d]^{\ensuremath{\mathbin{??}\mathrm{2}}}
\\
     \ensuremath{\mathbin{?}\mathrm{3}}
        \ar[d]_-{\ensuremath{\mathbin{??}\mathrm{3}}}
        \ar[r]^-{\ensuremath{\Varid{out}}}
&
     \ensuremath{\mathbin{?}\mathrm{4}}
           \ar[l]^-{\ensuremath{\mathbf{in}}}
            \ar[d]^{\ensuremath{\mathbin{??}\mathrm{4}}}
\\
    \ensuremath{\mathbin{?}\mathrm{5}}
&
    \ensuremath{\mathbin{?}\mathrm{6}}
        \ar[l]^-{\ensuremath{\mathbf{in}}}
}
%--------------------------------------
...
\xymatrix@C=2cm{
     \ensuremath{\Conid{Bdt}}
&
     \ensuremath{\Conid{A}\mathbin{+}\mathit B\times(\mathit C\times\Conid{Bdt}\times\Conid{Bdt})}
...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\lambda \Varid{a}\;\anonymous \to \Conid{Leaf}\;\Varid{a}}{\Varid{trash}}\;\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{10}{}\<[15]%
\>[15]{}\Varid{trash}\;(\Varid{lt1},\Varid{lt2})\;[\mskip1.5mu \mskip1.5mu]{}\<[36]%
\>[36]{}\mathrel{=}\Conid{Fork}\;(\Varid{lt1}\;[\mskip1.5mu \mskip1.5mu],\Varid{lt2}\;[\mskip1.5mu \mskip1.5mu]){}\<[E]%
\\
\>[5]{}\hsindent{10}{}\<[15]%
\>[15]{}\Varid{trash}\;(\Varid{lt1},\Varid{lt2})\;(\Conid{True}\mathbin{:}\Varid{t}){}\<[42]%
\>[42]{}\mathrel{=}\Varid{lt1}\;\Varid{t}{}\<[E]%
\\
\>[5]{}\hsindent{10}{}\<[15]%
\>[15]{}\Varid{trash}\;(\Varid{lt1},\Varid{lt2})\;(\Conid{False}\mathbin{:}\Varid{t})\mathrel{=}\Varid{lt2}\;\Varid{t}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks


%--------------------------------------
Diagrama da função \ensuremath{\Varid{navLTree}}:
